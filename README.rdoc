...
* homepage : https://github.com/AudioBear/cookbook-node
...
* node/version : indicates which version/revision to install. Default is the latest ('HEAD'). Since node evolves very quickly and is not always that stable, you might want to set it to a stable version (for example 'v0.8.12')
...
Copyright:: 2011, Tikibooth Limited, 2012 AudioBear Contributors
